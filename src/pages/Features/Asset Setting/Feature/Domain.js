...
const Domain = () => {
                    ...
                    <AvForm>
                        ...
                        <Button
                            ...
                            onClick={() => {
                                // console.log("cliecekd", productData.Value);
                                tog_standard4();
                                seteditValue(productData.Domain)
    ...
    async function getassetListData(event) {
        const response = await fetch(
            `${process.env.REACT_APP_DEFAULTPATH}getassetlist-domain`,
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
        ...
        const data = await response.json();
        if (data) {
            console.log("response assetlist -domain", data.domainList);
            ...
            setProductData(data.domainList);
    ...
    async function editDomainValue() {
        ...
        if (domainRegex.test(updatedValue)) {
            ...
            swal({
                ...
                .then(async (willDelete) => {
                    if (willDelete) {
                        ...
                        await axios.post(`${process.env.REACT_APP_DEFAULTPATH}edit-domain-assetlist`, {
            ...
            swal("Job Fail!", "You entered wrong domain Format!", "error");
        }
    }
        ...
        swal({
            ...
            .then(async (willDelete) => {
                if (willDelete) {
                    ...
                    await axios.post(`${process.env.REACT_APP_DEFAULTPATH}delete-assetlist-domain-element`, {
            ...
            <div className="userProfile credentialBreachProfile">
                ...
                <Row>
                    <Breadcrumbs
                        ...
                        breadcrumbItem="Domain "
                        breadcrumbFeature="Domain"
                    />
                </Row>
