...
const Subdomain = () => {
                ...
                <>
                    <AvForm>
                        ...
                        <Button
                            ...
                            onClick={() => {
                                // tog_standard4();
                                seteditValue(productData.Subdomain)
    ...
    async function getassetListData(event) {
        const response = await fetch(
            `${process.env.REACT_APP_DEFAULTPATH}getassetlist-subdomain`,
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
        ...
        if (data) {
            ...
            // }
            setProductData(data.subdomainList);
    ...
    async function editSubdomainValue() {
        // console.log("updated value", updatedValue)

        let subdomain_regex = /(^|^[^:]+:\/\/|[^\.]+\.)dream11\.com/
        if (subdomain_regex.test(updatedValue)) {
            swal({
                title: "Are you sure?",
                ...
                .then(async (willDelete) => {
                    if (willDelete) {
                        ...
                        await axios.post(`${process.env.REACT_APP_DEFAULTPATH}edit-subdomain-assetlist`, {
            ...
            swal("Job Fail!", "You entered wrong subdomain Format!", "error");
        }
    }
        ...
        swal({
            ...
            .then(async (willDelete) => {
                if (willDelete) {
                    ...
                    await axios.post(`${process.env.REACT_APP_DEFAULTPATH}delete-assetlist-element`, {
            ...
            <div className="userProfile credentialBreachProfile">
                ...
                <Row>
                    <Breadcrumbs
                        ...
                        breadcrumbItem="Subdomain "
                        breadcrumbFeature="Subdomain"
                    />
                </Row>
