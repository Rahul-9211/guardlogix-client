        ...
        async function getBarChartData() {
            ...
            for (var i = 0; i < data.data.length; i++) {
                ...
                for (var j = 0; j < data.data[i].Data.length; j++) {
                    ...
                    if(data.data[i].Data[j].A != null){
                        for (var k = 0; k < data.data[i].Data[j].A.length; k++) {
                            var temp = data.data[i].Data[j].A[k];
                    ...
                    if(data.data[i].Data[j].AAAA != null){
                        for (var k = 0; k < data.data[i].Data[j].AAAA.length; k++) {
                            var temp = data.data[i].Data[j].AAAA[k];
                    ...
                    if(data.data[i].Data[j].CNAME != null){
                        for (var k = 0; k < data.data[i].Data[j].CNAME.length; k++) {
                            var temp = data.data[i].Data[j].CNAME[k];
                    ...
                    if(data.data[i].Data[j].SOA != null){
                        for (var k = 0; k < data.data[i].Data[j].SOA.length; k++) {
                            var temp = data.data[i].Data[j].SOA[k];
                    ...
                    if(data.data[i].Data[j].MX != null){
                        for (var k = 0; k < data.data[i].Data[j].MX.length; k++) {
                            var temp = data.data[i].Data[j].MX[k];
                    ...
                    if(data.data[i].Data[j].NS != null){
                        for (var k = 0; k < data.data[i].Data[j].NS.length; k++) {
                            var temp = data.data[i].Data[j].NS[k];
                    ...
                    if(data.data[i].Data[j].TXT != null){
                        for (var k = 0; k < data.data[i].Data[j].TXT.length; k++) {
                            var temp = data.data[i].Data[j].TXT[k];
