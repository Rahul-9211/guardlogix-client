...
import logoMain from "../../assets/images/logo/logoSVGmain.svg";
// import logoSmall from "../../assets/images/logoSmall.png";
import logoSmall from "../../assets/images/logoSmall2.png";
      ...
      <header id="page-topbar">
        <div className="navbar-header">
          <div className="d-flex">
            <div className="navbar-brand-box">
              <Link to="/dashboard" className="logo logo-dark">
                <span className="logo-sm">
                  <img src={logoSmall} alt="" height="24" />
                </span>
                <span className="logo-lg">
                  <img src={logoMain} alt="" height="24" /> 
            ...
            <form className="app-search d-none d-lg-block searchBar1" >
          ...
          <div className="d-flex searchBar1">
